...
SHIPPED = ["launchd schedule, no daemon between ticks", "dollar budget, timeout, turn cap", "rolling daily budget",
           ...
           "pi sessions: process table and session file, seen and stopped, never joined",
           ...
           "dashboard: grouping, filter", "menu: folder, jobs, config, help",
           ...
           "the pane: on or off, right or bottom, its own columns, all from jobs.yaml"]
